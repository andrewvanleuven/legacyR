...
* This [folder](https://github.com/andrewvanleuven/legacyR/tree/master/plot) contains a variety of visualizations and maps, most of them generated in the `clustr_discrim.R` script. The [README](plot/viz_guide.md) (*still in progress*) contains a description of each of the most relevant graphics within the folder.
